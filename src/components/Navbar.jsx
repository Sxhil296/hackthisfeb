...
const Navbar = () => {
  ...
  return (
    <div className='z-90 flex justify-between items-center h-24 max-w-[1140px] mx-auto px-4 border-b border-gray-600 text-white'>
      ...
      <ul className={nav ? 'fixed z-50 left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
          ...
          <Link to='about'><li className='p-4 border-b border-gray-600 hover:text-[#FF1616]'>About</li></Link>
        <Link to='prizes'><li className='p-4 border-b border-gray-600 hover:text-[#FF1616]'>Prizes</li></Link>
        <Link to='sponsors'><li className='p-4 border-b border-gray-600 hover:text-[#FF1616]'>Sponsors</li></Link>
        <Link to='questions'><li className='p-4 border-b border-gray-600 hover:text-[#FF1616]'>FAQs</li></Link>
